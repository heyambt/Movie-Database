...
const About = () => (
    <main>
        ...
        <p>
        The Reels App is an online database, designed and created by Heyam Banitorof and Vidhi Shukla, which allows you to search through movies and see the information related to them online.</p> 
        <p>
